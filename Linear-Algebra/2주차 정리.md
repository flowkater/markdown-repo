...
즉, x_3, x_4 를 x_3 = 0, x_4 = -1 로 두어도 된다. (자유변수이기 때문에 아무 실수를 두면 된다.)
...
즉, $C(A) = span(\begin{bmatrix}1 \\ 2 \\ 3 \end{bmatrix}, \begin{bmatrix}1 \\ 1 \\ 4 \end{bmatrix}, \begin{bmatrix}1 \\ 4 \\ 1 \end{bmatrix}, \begin{bmatrix}1 \\ 3 \\ 2 \end{bmatrix})$ 의 열벡터 각각을 span(\vec{v_1}, \vec{v_2}, \vec{v_3}, \vec{v_4}) 일때, 벡터 \vec{v_3}, \vec{v_4} 는 위 (2), (1) 처럼 다른 두 벡터, \vec{v_1}, \vec{v_3}의 결합으로 나타낼 수 있다.
